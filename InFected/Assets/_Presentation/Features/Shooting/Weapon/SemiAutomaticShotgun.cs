...
{
    public class SemiAutomaticShotgun : Weapon
    {
        [Header("Bullet")]
        ...
        {
            float angleStep = WeaponData.WeaponParameters.ShootingSpread * 2 / (projectilesPerShot - 1);

            for (int i = 0; i < projectilesPerShot; i++)
            {
                float angleDeviation = WeaponData.WeaponParameters.ShootingSpread - angleStep * i;
